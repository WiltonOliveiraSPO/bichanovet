...
public class TelaVendas extends BaseFrame {
    ...
    private void inicializarComponentes() {
        ...
        painelDados.add(new JLabel("ID Venda:"));
        painelDados.add(txtId);
        painelDados.add(new JLabel("Cliente:"));
        painelDados.add(cbCliente);
        painelDados.add(new JLabel("Data Venda:"));
        painelDados.add(dateVenda);
        painelDados.add(new JLabel("Forma Pagamento:"));
        painelDados.add(cbFormaPagamento);
        painelDados.add(new JLabel("Observacoes:"));
        ...
        JPanel painelAddItem = new JPanel(new GridLayout(2, 4, 10, 10));
        ...
        painelAddItem.add(new JLabel("Produto/Servico:"));
        painelAddItem.add(cbProduto);
        painelAddItem.add(new JLabel("Quantidade:"));
        painelAddItem.add(txtQuantidade);
        painelAddItem.add(new JLabel("Preco Unitario:"));
        ...
        painelConteudo.add(painelDados, BorderLayout.NORTH);
